...
import { GetBalanceResponse, ValidationErrorResponse, ErrorResponse } from './getBalanceTypes';
...
export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<GetBalanceResponse | ValidationErrorResponse | ErrorResponse>
) {
  ...
  try {
    const response: AxiosResponse<GetBalanceResponse> = await client.get('/balance');
